...
class AgenticCostOptimizer:
    ...
    def handle_query(self, question):
        ...
        self.parameters['final_response'] = self.llm.invoke(
            f"Start with a bold heading: 𝗙𝗜𝗡𝗔𝗟 𝗜𝗡𝗦𝗜𝗚𝗛𝗧𝗦:.This is the response provided by the Cost Optimization Agent: {chat}. Generate a final response to be shown to the client.")
