...
class Static_CostOptimization_Class():
    ...
    def handle_query(self, question):
        ...
        result = self.llm.invoke(
            f"Start with a bold heading: 𝗙𝗜𝗡𝗔𝗟 𝗜𝗡𝗦𝗜𝗚𝗛𝗧𝗦:This is the response provided by the Static Cost Optimization Agent: {chat}. Generate a final response to be shown to the client.")
        self.parameters['final_response'] = result
